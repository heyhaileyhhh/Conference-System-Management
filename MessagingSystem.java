...
public class MessagingSystem {
  ...
  /**
   * Prompts the user with a sub-menu of different options if they select "view your conversations".
   */
  ...
  /**
   * Mark the user-selected conversation as Unread.
   */
  ...
  /**
   * Mark the user-selected conversation as Read.
   */
  ...
  /**
   * Add the user-selected conversation to archive.
   */
  ...
  /**
   * View all the archived conversations of the user.
   */
  ...
  private boolean checkReturnToPreviousPage(String input) {
    if (input.equals("")){
      return true;
    }
    return false;
